...
const steps = {
    'step1': {
      '_default': `Would you like to choose to wake up and safely escape the the car? <a href=${host}/step/step1?answer=yes>Yes</a> or <a href=${host}/step/step1?answer=no>No</a>`,
      'yes': `You wind the window down and pull your sister out of the window with you. You spend hours that turn into days searching for your home. You find it eventually but it has a sold out sign on it. You come to an epiphany. Your parents must have thought you and your sister have died and moved back to Canada. Go back one <a href=${host}/step/step1>step</a> to retry.`,
